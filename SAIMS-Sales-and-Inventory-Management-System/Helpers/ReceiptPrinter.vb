...
Public Module ReceiptPrinter
    ...
    Private Function GenerateReceiptHtml(saleRow As DataRow, dtItems As DataTable) As String
        ...
        sb.AppendLine("    .header .address { margin: 2px 0 4px 0; color: #555; font-size: 12px; font-weight: 500; }")
        ...
        sb.AppendLine($"      <h2>{STORE_NAME.ToUpper()}</h2>")
        sb.AppendLine($"      <p class='address'>{STORE_ADDRESS}</p>")
        sb.AppendLine("      <p>Sales & Inventory Management</p>")
